...
type rxjs$OperatorFunction<T, R> = rxjs$UnaryFunction<
  rxjs$Observable<T>,
  rxjs$Observable<R>
>;
...
declare class rxjs$Observable<+T> {
  constructor(
    subscribe?: (observer: rxjs$Observer<T>) => rxjs$TeardownLogic
  ): void;
  ...
  pipe<R>(...operations: rxjs$OperatorFunction<T, R>[]): rxjs$Observable<R>;
