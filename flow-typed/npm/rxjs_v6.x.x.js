// flow-typed signature: 7130f4fbec576525d44aa11858134ec3
// flow-typed version: afa09169c8/rxjs_v6.x.x/flow_>=v0.34.x
...
declare module "rxjs/observable/forkJoin" {
  declare module.exports: {
    ...
    forkJoin<A>(a: Array<rxjs$Observable<any>>, _: void): rxjs$Observable<A>,
...
declare module "rxjs/operators" {
  declare module.exports: {
    ...
    race<+T>(
      other: rxjs$Observable<T>
    ): (rxjs$Observable<T>) => rxjs$Observable<T>,

    repeat<+T>(count?: number): (rxjs$Observable<T>) => rxjs$Observable<T>,

    buffer<+T>(
      bufferBoundaries: rxjs$Observable<any>
    ...
    skipUntil<+T>(
      other: rxjs$Observable<any> | Promise<any>
    ): (rxjs$Observable<T>) => rxjs$Observable<T>,
...
type rxjs$Operators$withLatestFrom = {
  ...
  <T, A>(
    a: rxjs$Observable<A>,
    _: void
  ): (rxjs$Observable<T>) => rxjs$Observable<[T, A]>,
