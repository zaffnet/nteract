// flow-typed signature: cee1a183c37e203d3d4e817c5a02fc8a
// flow-typed version: <<STUB>>/mock-require_v^2.0.0/flow_v0.54.0
...
declare module 'mock-require/test/node-path/in-node-path' {
  declare module.exports: any;
}
...
declare module 'mock-require/test/node-path/in-node-path.js' {
  declare module.exports: $Exports<'mock-require/test/node-path/in-node-path'>;
}
