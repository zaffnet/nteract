...
describe("ImageDisplay", () => {
  it("creates an image based on data and mimetype", () => {
    const component = shallow(<ImageDisplay data={imageData} mimetype="image/png" />);
...
describe("ImageDisplay", () => {
  it("accepts metadata for the size", () => {
    const component = shallow(<ImageDisplay data={imageData} mimetype="image/png" metadata={{ width: "200" }} />);

    const img = component.find("img");
    expect(img.prop("width")).toEqual("200");

    const component2 = shallow(<ImageDisplay data={imageData} mimetype="image/png" metadata={{ width: "200", height: "300" }} />);
...
describe("PNGDisplay", () => {
  it("renders a single image base64 inline", () => {
    ...
    expect(component.equals(<ImageDisplay mimetype="image/png" data={imageData} />)).toEqual(true);
  });
});
...
describe("JPEGDisplay", () => {
  it("renders a single image base64 inline", () => {
    ...
    expect(component.equals(<ImageDisplay mimetype="image/jpeg" data={imageData} />)).toEqual(true);
  });
});
...
describe("GIFDisplay", () => {
  it("renders a single image base64 inline", () => {
    ...
    expect(component.equals(<ImageDisplay mimetype="image/gif" data={imageData} />)).toEqual(true);
  });
});
