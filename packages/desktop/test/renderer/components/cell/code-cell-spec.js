...
describe("CodeCell", () => {
  it("can be rendered", () => {
    const cell = shallow(<CodeCell cell={emptyCodeCell} {...sharedProps} cellStatus={Immutable.Map(
          {
            outputHidden: false,
            inputHidden: false,
  ...
  it("creates an editor", () => {
    ...
    const cell = mount(<Provider store={store}>
        <CodeCell cell={emptyCodeCell} {...sharedProps} cellStatus={Immutable.Map(
            {
              outputHidden: false,
              inputHidden: false,
              outputExpanded: false
